 ...
 * @ingroup Skins
 */
class SkinUMass extends SkinTemplate {
	/** Using monobook. */
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'umass/main.css', 'screen' );
		if( $wgHandheldStyle ) {
			// Currently in testing... try 'chick/main.css'
			$out->addStyle( $wgHandheldStyle, 'handheld' );
		}

		$out->addStyle( 'umass/IE50Fixes.css', 'screen', 'lt IE 5.5000' );
		$out->addStyle( 'umass/IE55Fixes.css', 'screen', 'IE 5.5000' );
		$out->addStyle( 'umass/IE60Fixes.css', 'screen', 'IE 6' );
		$out->addStyle( 'umass/IE70Fixes.css', 'screen', 'IE 7' );

		$out->addStyle( 'umass/rtl.css', 'screen', '', 'rtl' );
 ...
 * @ingroup Skins
 */
class UMassTemplate extends QuickTemplate {
	var $skin;
	/**
...
<input name="sa" value="Go" style="font-size: 11px; font-family: Verdana,sans-serif;" type="submit">
...
<?php		}
		...
		wfRunHooks( 'UMassTemplateToolboxEnd', array( &$this ) );
